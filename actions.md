...
| [THROTTLE](https://github.com/OpenC2-org/docs-contributors/blob/master/actions/throttle.md) | The THROTTLE action adjusts the throughput of entire data flow to a different  rate.  | 
...
| [ALERT](https://github.com/OpenC2-org/docs-contributors/blob/master/actions/alert.md) | ALERT is used to signal the occurrence of an event or error. | 
